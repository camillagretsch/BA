...
public class FloorState extends Model implements EntryStateInterface {
    ...
    private final static String NAME = "Boden ";
     ...
     * @return
     */
    public static Table2 createTable(FloorState floor, float posX, float posY, float pageWidth, String[] headers, byte[] cross) {
